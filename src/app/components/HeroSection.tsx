    ...
    <section>
      <div className="flex flex-col-reverse sm:grid sm:grid-cols-12">
        ...
        <div className="sm:col-span-7 place-self-center text-center sm:text-left px-4 sm:px-0">
          ...
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full bg-white hover:bg-slate-800 text-black border border-black mt-3">
              Download CV
            </button>
          </div>
        </div>
        ...
        <div className="sm:col-span-5 place-self-center mt-4 lg:mt-0">
          <div className="rounded-full bg-[#181818] w-[300px] h-[450px] relative mx-auto sm:mx-0">
            <Image
